...
from lib.prune_opt import prune_opt_full_layer, prune_opt_mask, prune_wanda, prune_magnitude, prune_sparsegpt, prune_thanos, prune_ablate, check_sparsity, find_layers
...
def main():
    ...
    parser.add_argument("--prune_method", type=str, choices=["magnitude", "wanda", "sparsegpt", "thanos",
                                                             ...
                                                             "ablate_wanda_iter", "search", "opt_mask", "opt_full_layer"], default="opt_mask")
    ...
    #parser.add_argument('--save_model', type=str, default="llm_weights/unstructured/opt-125m/wanda", help='Path to save the pruned model.')
    ...
    if args.sparsity_ratio != 0:
        ...
        elif args.prune_method == "opt_full_layer":
            prune_opt_full_layer(args, model, tokenizer, device)
