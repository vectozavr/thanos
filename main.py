...
def main():
    ...
    parser.add_argument('--nsamples', type=int, default=4096, help='Number of calibration samples.')
    ...
    parser.add_argument('--save_model', type=str, default="llm_weights/unstructured/llama-2-7b/wanda", help='Path to save the pruned model.')
