...
def main():
    ...
    parser.add_argument('--model', type=str, help='LLaMA model', default="microsoft/Phi-3-mini-4k-instruct")
    ...
    parser.add_argument('--save_model', type=str, default="llm_weights/unstructured/phi-3-mini-4k-instruct/thanos", help='Path to save the pruned model.')
