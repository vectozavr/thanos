...
# llama-7b with thanos pruning method
echo "Running with thanos pruning method"
run_python_command "thanos" "unstructured" "out/llama_7b/unstructured/thanos/"
run_python_command "thanos" "2:4" "out/llama_7b/2-4/thanos/"
run_python_command "thanos" "4:8" "out/llama_7b/4-8/thanos/"
echo "Finished thanos pruning method"
